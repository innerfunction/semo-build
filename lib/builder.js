...
Builder.prototype.buildFeed = function( feed ) {
    ...
    return q.fcall(function loadBuildData() {
        ...
        // TODO: Need to review view names.
        return q.all([
            build.db.view('semo-build-feed','feed-record', feedid ),
            build.db.view('semo-build-feed','feed-post', feedid )
        ])
        ...
        if( build.hasNewContent() ) {
            ...
            .then(function trimOlderBuilds() {
                ...
                return q.seqall( oldBuilds.map(function( build ) {
                    ...
                    // manner done here (although, build docs could also be maked as inactive
