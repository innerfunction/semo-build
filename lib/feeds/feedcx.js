var Log = require('log4js').getLogger('semo-build.feeds.cx');
...
Context.prototype.clean = function( fn ) {
    ...
    this.add2q(function() {
        ...
        return cx._db.view('semo-build','feed-posts', cx._record.$feedID )
        .then(function( data ) {
...
exports.newContext = function( record, db ) {
    return new Context( record, db );
}
