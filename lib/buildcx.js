...
function newCx( is, find, build ) {
    ...
    var uriSchemes = feed.uri.uriSchemes||{};
    ...
    File.prototype.href = am(function( ctx ) {
        ...
        .then(function( path ) {
            ...
            // Path of base path parent dir; or build output path, if template not being eval'd.
            var baseDir = basePath ? mods.path.dirname( basePath ) : outPath;
            // Result is the file's path relative to the base dir.
