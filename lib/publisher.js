...
Publisher.prototype.currentContextResponse = function( currBuild, res ) {
    var pub = this;
...
Publisher.prototype.errorResponse = function( res ) {
    Log.error( err );
    mods.utils.sendJSON( res, { status: 'error' }, 500 );
}
    ...
    uspace.map({
        ...
        '/': function( req, res ) {
            ...
            .then(function( builds ) {
                ...
                if( builds.length > 0 ) {
                    return pub.currentContextResponse( builds[0], res );
                }
