...
function makeCDBClient( db ) {
    return {
        ...
        getFeedRecord: function( feedID ) {
            var db = this;
            return db.view( CDBDesignDocID, 'feed-record', feedID )
            .then(function( data ) {
        ...
        getFeedPosts: function( feedID ) {
            return db.view( CDBDesignDocID, 'feed-post', feedID )
            .then(function( data ) {
                return data.rows;
            });
        },
        ...
        getFeedBuilds: function( feedID ) {
            return db.view( CDBDesignDocID, 'builds', [ feedID ])
            .then(function( data ) {
